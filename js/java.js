...
if ((isNaN(nrlinhas||nrcol||nrlinhas1||nrcol1))){
    alert("O número informado não pode ser uma letra. Recarregue a página e informe uma matriz condizente.")
} else {
if (nrcol != nrlinhas1){
...
//exibição  
document.write( "<p> Matriz Resultante:");
document.write( "<table class = 'comBordaComplexa' border=1>");
